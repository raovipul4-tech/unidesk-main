  ...
  const router = useRouter();
    ...
    <div className="container mx-auto px-6 py-20">
        <div className="max-w-5xl mx-auto">
            ...
            <div className="mb-12 bg-white rounded-2xl p-8 border border-gray-200 shadow-lg">
                <h2 className="text-center text-gray-700 font-bold mb-6">Quick Access to All Portals</h2>
