...
export default function LoginPage() {
  ...
  return (
    <>
      <Header />
      <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 min-h-screen flex flex-col pt-40 sm:pt-44 md:pt-48">
        ...
        <div className="flex-1 w-full px-3 sm:px-4 md:px-6 py-6 sm:py-8 relative z-10 flex items-center justify-center">
          <div className="w-full max-w-5xl">
              ...
              <div className="text-center mb-8 sm:mb-12">
                  <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-2 sm:mb-3 leading-tight">Welcome Back</h1>
                  <p className="text-sm sm:text-base md:text-lg text-slate-300">Choose your product to access your account</p>
              </div>

              {/* Quick Access Buttons - All Portals */}
              <div className="mb-8 sm:mb-12 bg-slate-800/50 backdrop-blur rounded-xl sm:rounded-2xl p-5 sm:p-6 border border-slate-700 shadow-2xl hover:shadow-2xl transition-shadow">
                  <h2 className="text-center text-white font-bold mb-4 sm:mb-6 text-base sm:text-lg">Quick Access to All Portals</h2>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6 mb-8 sm:mb-12">
                  ...
                  {/* UniCRM Login */}
                  <div className="bg-slate-800/50 backdrop-blur rounded-lg sm:rounded-xl p-5 sm:p-6 border border-slate-700 hover:border-blue-500 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-300 relative overflow-hidden group">
                      <div className="flex flex-col items-center text-center space-y-3 sm:space-y-4 relative z-10">
                          ...
                          {/* Title */}
                          <div>
                              <h3 className="text-xl sm:text-2xl font-bold text-white mb-1">UniCRM</h3>
                              <p className="text-xs sm:text-sm text-slate-300">Smart CRM & Lead Management</p>
                          </div>
                          
                          {/* Features */}
                          <div className="text-left w-full space-y-1.5 sm:space-y-2 bg-slate-700/50 rounded-lg p-3 sm:p-4 border border-slate-600">
                  ...
                  {/* UniChat Login */}
                  <div className="bg-slate-800/50 backdrop-blur rounded-lg sm:rounded-xl p-5 sm:p-6 border border-slate-700 hover:border-green-500 hover:shadow-2xl hover:shadow-green-500/20 transition-all duration-300 relative overflow-hidden group">
                      <div className="flex flex-col items-center text-center space-y-3 sm:space-y-4 relative z-10">
                          {/* Logo */}
                          ...
                          {/* Title */}
                          <div>
                              <h3 className="text-xl sm:text-2xl font-bold text-white mb-1">UniChat</h3>
                              <p className="text-xs sm:text-sm text-slate-300">WhatsApp Business API</p>
                          </div>
              ...
              {/* Additional Info */}
              <div className="bg-slate-800/50 backdrop-blur rounded-lg sm:rounded-xl p-5 sm:p-6 border border-slate-700 shadow-md mb-8 sm:mb-12">
                  <div className="grid sm:grid-cols-3 gap-3 sm:gap-4 text-center">
                      <div className="bg-slate-700/50 rounded-lg p-3 sm:p-4 hover:shadow-md transition-shadow duration-300 border border-slate-600">
                          ...
                          <h4 className="text-white font-bold text-sm sm:text-base mb-1">Don't have an account?</h4>
                          <p className="text-slate-300 text-xs sm:text-sm mb-2">Start your free trial today</p>
                          <button onClick={() => router.push('/pricing')} className="text-blue-400 hover:text-blue-300 font-bold hover:underline text-xs sm:text-sm">View Pricing →</button>
                      </div>
                      <div className="bg-slate-700/50 rounded-lg p-3 sm:p-4 hover:shadow-md transition-shadow duration-300 border border-slate-600">
                          ...
                          <h4 className="text-white font-bold text-sm sm:text-base mb-1">Need Help?</h4>
                          <p className="text-slate-300 text-xs sm:text-sm mb-2">Our support team is here for you</p>
                          <a href="mailto:support@unidesk.in" className="text-blue-400 hover:text-blue-300 font-bold hover:underline text-xs sm:text-sm">Contact Support →</a>
                      </div>
                      <div className="bg-slate-700/50 rounded-lg p-3 sm:p-4 hover:shadow-md transition-shadow duration-300 border border-slate-600">
                          ...
                          <h4 className="text-white font-bold text-sm sm:text-base mb-1">Book a Demo</h4>
                          <p className="text-slate-300 text-xs sm:text-sm mb-2">See Unidesk in action</p>
                          <button onClick={() => router.push('/contact')} className="text-blue-400 hover:text-blue-300 font-bold hover:underline text-xs sm:text-sm">Schedule Demo →</button>
                      </div>
                  </div>
              </div>
              ...
              <div className="text-center">
                  <p className="text-slate-300 text-sm sm:text-base font-medium mb-4">Questions? Reach out to us</p>
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4">
                      <a href="mailto:support@unidesk.in" className="bg-slate-700/50 hover:bg-blue-500/20 text-slate-200 hover:text-blue-300 px-3 sm:px-4 py-2 rounded-lg font-semibold transition flex items-center shadow-sm hover:shadow-md border border-slate-600 hover:border-blue-500 text-xs sm:text-sm">
                      ...
                      <a href="https://wa.me/919625878600" className="bg-slate-700/50 hover:bg-green-500/20 text-slate-200 hover:text-green-300 px-3 sm:px-4 py-2 rounded-lg font-semibold transition flex items-center shadow-sm hover:shadow-md border border-slate-600 hover:border-green-500 text-xs sm:text-sm">
                  ...
                  {/* Trust Badge */}
                  <div className="mt-4 sm:mt-6 flex items-center justify-center space-x-2 text-slate-300 text-xs sm:text-sm">
